...
export const legserviceArticles: LegserviceArticle[] = [
  ...
  },
  {
    ...
    aantalMinimum: 1,
    berekening: "Stuk",
    keuzeServicesOptional: [
      "TRAP-UITL-26-RVS",
      "TRAP-UITL-26-ZIL",
      "TRAP-UITL-26-ZWA",
      "TRAP-NEUS-PVC-RVS-14x43-3M",
      "TRAP-NEUS-PVC-ZWA-14x43-3M",
      "DUO-HK-2430-ZIL-3M",
    ],
    van: 0,
    tot: 9999
  ...
  {
    productCode: "TRAP-UITL-26-RVS",
    description: "Trapuitloopprofiel 26 mm RVS t.b.v. losse neus",
    serviceType: "afwerken",
    isMandatory: false,
    category: "Accessoires",
    eenheid: "Stuk",
    configuratorName: "TRAP-UITL-26-RVS",
  ...
  {
    productCode: "TRAP-UITL-26-ZIL",
    description: "Trapuitloopprofiel 26 mm zilver t.b.v. losse neus",
    serviceType: "afwerken",
    isMandatory: false,
    category: "Accessoires",
    eenheid: "Stuk",
    configuratorName: "TRAP-UITL-26-ZIL",
    subcategorie: "Profielen",
    aantalMinimum: 1,
    berekening: "Stuk",
    van: 0,
  ...
  {
    productCode: "TRAP-UITL-26-ZWA",
    description: "Trapuitloopprofiel 26 mm zwart t.b.v. losse neus",
    serviceType: "afwerken",
    isMandatory: false,
    category: "Accessoires",
    eenheid: "Stuk",
    configuratorName: "TRAP-UITL-26-ZWA",
    subcategorie: "Profielen",
    aantalMinimum: 1,
    berekening: "Stuk",
    van: 0,
  ...
  {
    productCode: "TRAP-NEUS-PVC-RVS-14x43-3M",
    description: "Trapneusprofiel PVC RVS 14x43mm 3m",
    serviceType: "afwerken",
    isMandatory: false,
    category: "Accessoires",
    eenheid: "Stuk",
    configuratorName: "TRAP-NEUS-PVC-RVS-14x43-3M",
    subcategorie: "Profielen",
    aantalMinimum: 1,
    berekening: "Stuk",
    van: 0,
  ...
  {
    productCode: "TRAP-NEUS-PVC-ZWA-14x43-3M",
    description: "Trapneusprofiel PVC zwart 14x43mm 3m",
    serviceType: "afwerken",
    isMandatory: false,
    category: "Accessoires",
    eenheid: "Stuk",
    configuratorName: "TRAP-NEUS-PVC-ZWA-14x43-3M",
    subcategorie: "Profielen",
    aantalMinimum: 1,
    berekening: "Stuk",
    van: 0,
