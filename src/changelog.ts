...
export const changelog: ChangelogEntry[] = [
  {
    ...
    },
    {
        ...
        date: "2026-04-30",
        changes: [
            "Nieuw veld '10 dB norm' toegevoegd aan de artikelregel (na Merk), met waarden Ja/Nee/Geen — ingevuld op 9 dummy-artikelen als mix",
        ],
    },
    {
        version: "1.5.0",
    ...
    },
    {
        ...
        date: "2026-04-30",
        changes: [
            "LEG PROFIEL: discrepantie-popup als totaal geselecteerde profielen afwijkt van service-aantal, met optie om service automatisch aan te passen",
        ],
    },
    {
        version: "1.4.6",
